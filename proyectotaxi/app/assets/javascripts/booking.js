include ('/assets/jquery-ui-1.10.3.custom.min.js');
include ('/assets/jquery.fancyform.js');
include ('/assets/jquery.placeholder.js');
include ('/assets/regula.js');
	...
	$.fn.bookingForm=function(options){
		return this.each(function(){
			...
			object = {
				...
				ownerEmail:'cholopower@gmail.com', // destination e-mail, message will be send on this e-mail
